...
//     const [selectedCntry, setSelectedCntry] = useState<CountryType | null>({dial_code:'',name:''}) //(null)
...
//                         renderOption={(option) => (
//                             <React.Fragment>
//                                 <span><img width='35' src={`https://disease.sh/assets/img/flags/${option.code.toLowerCase()}.png`} alt="flag" /> </span>
//                                 {`${option.name}`}
//                             </React.Fragment>
//                         )}
//                         renderInput={(params) => (
...
//                         renderOption={(option) => (
//                             <React.Fragment>
//                                 <span><img width='35' src={`https://flagpedia.net/data/flags/w702/${option.code.toLowerCase()}.webp`} alt="flag" /> </span>
